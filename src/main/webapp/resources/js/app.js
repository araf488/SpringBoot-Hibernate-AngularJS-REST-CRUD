...
angular.module('myApp').factory('Person', ['$resource', function ($resource) {
    return $resource('http://localhost:8080/Spring4RESTAngularJS/person/:personId', {personId: '@pid'},
	{
...
angular.module('myApp').controller('PersonController', ['$scope', 'Person', function($scope, Person) {
    var ob = this;
    ob.persons=[];
